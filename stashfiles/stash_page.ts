  ...
  return (
    <Flex direction="column" gap="4" maxWidth="900px" className="mx-auto p-4">
      <Flex justify="between" align="center">
        <div>
          <Text size="6" weight="bold">Stash</Text>
          {data && (
            <Text size="2" color="gray">
              Gesamt: {data.total_current.toFixed(1)}g verfügbar | {data.total_withdrawn.toFixed(1)}g entnommen
            </Text>
          )}
        </div>
      ...
      {data && data.items.length === 0 ? (
        <Flex direction="column" align="center" gap="2" className="py-12">
          <Text size="4" color="gray">Noch keine Items im Stash</Text>
                ...
                <Table.Row key={item.id}>
                  ...
                  <Table.Cell>
                    <Flex direction="column" gap="1">
                      <Text weight="bold">{item.quantity_current.toFixed(1)}g</Text>
                  ...
                  <Table.Cell>
                    <Text color="gray">{item.quantity_start.toFixed(1)}g</Text>
                  </Table.Cell>
                  <Table.Cell>
