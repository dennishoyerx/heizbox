...
import { fetchStashItems, createStashItem, withdrawStashItem, deleteStashItem } from '../../api-stash';
import { useWebSocketEvent } from '../WebSocketContext';
import { useCallback } from 'react';
import type { CreateStashItemRequest, WithdrawStashItemRequest } from '@heizbox/types';
...
export const useStash = () => {
  ...
  const withdrawMutation = useMutation({
    mutationFn: ({ itemId, data }: { itemId: string; data: WithdrawStashItemRequest }) =>
